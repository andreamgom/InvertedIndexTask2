...
public class SqliteReader implements DatabaseReader {
    ...
    @Override
    public boolean update(String sql, String title, String author, int id) throws SQLException {
    ...
    @Override
    public int create(String sql, String title, String author) throws SQLException {
